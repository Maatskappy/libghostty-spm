...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/Maatskappy/libghostty-spm/releases/download/storage.1.2.17/GhosttyKit.xcframework.zip",
            checksum: "6cbea992a6b3bcb96e1e6f8da69fd292e564cd271b70ef0bb511fc315c9660dc"
        ),
        .testTarget(
            name: "GhosttyKitTest",
