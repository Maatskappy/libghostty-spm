...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/Maatskappy/libghostty-spm/releases/download/storage.1.2.16/GhosttyKit.xcframework.zip",
            checksum: "b45e7f14d9f42acbe7da2306a3c95395d2bbc41371ccc686b222c68fc6e57d76"
        ),
        .testTarget(
            name: "GhosttyKitTest",
