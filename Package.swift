...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/Maatskappy/libghostty-spm/releases/download/storage.1.2.12/GhosttyKit.xcframework.zip",
            checksum: "26dd67eec8bbd4dc6d8bbae674e794e919a5f152a3132c8f1553246fbdba4b43"
        ),
        .testTarget(
            name: "GhosttyKitTest",
