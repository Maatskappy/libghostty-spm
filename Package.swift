...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/Maatskappy/libghostty-spm/releases/download/storage.1.2.11/GhosttyKit.xcframework.zip",
            checksum: "4513a6ee78321ca9eb5d884f49a848c20a2cda42a7eae4f7e5cadf115439f7f3"
        ),
        .testTarget(
            name: "GhosttyKitTest",
