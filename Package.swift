...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/Maatskappy/libghostty-spm/releases/download/storage.1.2.9/GhosttyKit.xcframework.zip",
            checksum: "94e07fc8268b3aa197eafeca7c44b5335be3fb26e105276225e4d0446fa9783c"
        ),
        .testTarget(
            name: "GhosttyKitTest",
