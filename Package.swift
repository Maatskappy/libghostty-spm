...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/Maatskappy/libghostty-spm/releases/download/storage.1.2.14/GhosttyKit.xcframework.zip",
            checksum: "6f859637d91c1c5003c8315a236777d043492a7407fe6c06ae7ff3966a974766"
        ),
        .testTarget(
            name: "GhosttyKitTest",
