...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/Maatskappy/libghostty-spm/releases/download/storage.1.2.15/GhosttyKit.xcframework.zip",
            checksum: "a9fa3ed08c193053dd6a6a1bdf7b277d7e961c2a9e5fd290189879e4dcc80dcd"
        ),
        .testTarget(
            name: "GhosttyKitTest",
