...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/Maatskappy/libghostty-spm/releases/download/storage.1.2.10/GhosttyKit.xcframework.zip",
            checksum: "2a585ad27ac547b33c0df24a7e4ab7b0c0aff8bb43741a459b615c7d0a64bf3b"
        ),
        .testTarget(
            name: "GhosttyKitTest",
