...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/Maatskappy/libghostty-spm/releases/download/storage.1.2.18/GhosttyKit.xcframework.zip",
            checksum: "a8ee9f272773e65ce9dc83bb8aeb167f16774997f42e8cba4b8734f68b50d0ed"
        ),
        .testTarget(
            name: "GhosttyKitTest",
